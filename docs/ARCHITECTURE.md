...
Pure Go Vulkan implementation with a Vulkan 1.2 floor and goffi-based dynamic
function loading.
...
- Platform surface: VkWin32, VkXlib, VkMetal, and an Android/arm64 API 29+ preview
